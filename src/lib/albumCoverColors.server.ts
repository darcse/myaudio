...
async function loadCoverBuffer(coverUrl: string): Promise<Buffer | null> {
...
export async function extractDominantColorsFromCoverUrl(coverUrl: string): Promise<string[]> {
  try {
